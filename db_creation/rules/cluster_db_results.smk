rule cluster_db_results:
    ...
    params:
        ...
        or_multi_annot = config["rdir"] + "/annot_and_clust/pfam_multi_annot_name_acc_clan.tsv",
        ...
        multi_annot = config["rdir"] + "/clusterDB_results/pfam_multi_annot_name_acc_clan.tsv.gz",
