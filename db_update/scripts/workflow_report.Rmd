...
pfam_annot <- fread(paste0(dir,"/integrated_cluster_DB/pfam_name_acc_clan_multi.tsv.gz"),
...
```{r,echo=FALSE}
sp_sh <- fread(paste0(dir,"/integrated_cluster_DB/spurious_shadow_info.tsv.gz"),stringsAsFactors = F,header = F, sep="\t")
...
```{r,echo=FALSE,warning=FALSE}
clu_comm <- fread(paste0(dir,"/integrated_cluster_DB/cluster_communities.tsv.gz"),
                 stringsAsFactors = F,header = T)
...
HQ_clu <- fread(paste(dir,"/integrated_cluster_DB/HQ_clusters.tsv.gz",sep=""),
                 stringsAsFactors = F,header = T)
