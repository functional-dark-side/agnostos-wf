rule spurious_shadow:
    ...
    shell:
        ...
        join -12 -23 <(sort --parallel={threads} -k2,2 {params.all_shad}) \
                <(sort --parallel={threads} -T {params.local_tmp} -k3,3 {input.clu_info} ) > {params.tmp1}
        ...
        join -11 -23 <(sort --parallel={threads} -k1,1 {params.tmp1}) \
                <(sort --parallel={threads} -T {params.local_tmp} -k3,3 {input.clu_info} ) > {params.tmp2}
        ...
        join -12 -21 -a1 -a2 <(sort --parallel={threads} -T {params.local_tmp} -k2,2 {input.clu_info} ) \
        ...
        join -13 -21 -a1 <(sort --parallel={threads} -T {params.local_tmp} -k3,3 {output.sp_sh}) \
